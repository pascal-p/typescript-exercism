...
describe('Exponentiation of a real number to a rational number', () => {
  it('Raise a real number to a positive rational number/1', () => {
    const expected = 16.0
    expect(new Rational(4, 3).expreal(8)).toEqual(expected)
    // .toBeCloseTo(expected, 14)
  })

  it('Raise a real number to a positive rational number/2', () => {
    const expected = 256.0
    expect(new Rational(8, 6).expreal(64)).toEqual(expected)
  })
